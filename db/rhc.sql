...
-- Script date 03-12-2017 03:44:07
...
--
-- Definition for procedure AlcoholLevelDataManagement_public_sp_getAllRecords
--
CREATE DEFINER = 'root'@'localhost'
PROCEDURE AlcoholLevelDataManagement_public_sp_getAllRecords()
BEGIN
SELECT
  *
FROM rhc.rhc_alcohol_levels;
END
$$
